import { GeoCircle, GeoPoint, GeoPointReadOnly, UnitType } from 'msfssdk';
import { AirportFacility, AirportRunway, Facility } from 'msfssdk/navigation';
import { LegDefinition, FlightPathUtils } from 'msfssdk/flightplan';
 ...
 */
export class FacilityWaypoint<T extends Facility> extends AbstractWaypoint {
  private readonly _location: GeoPoint;
 ...
 */
export class AirportWaypoint<T extends AirportFacility> extends FacilityWaypoint<T> {
