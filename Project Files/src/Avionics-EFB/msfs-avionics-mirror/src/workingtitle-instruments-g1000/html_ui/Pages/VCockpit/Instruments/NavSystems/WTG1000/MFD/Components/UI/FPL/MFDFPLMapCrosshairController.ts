 ...
 */
export interface MFDFPLMapCrosshairControllerModules extends MapCrosshairControllerModules {
  /** Focus module. */
 ...
 * crosshair otherwise.
 */
export class MFDFPLMapCrosshairController<M extends MFDFPLMapCrosshairControllerModules> extends MapCrosshairController<M> {
  /** @inheritdoc */
