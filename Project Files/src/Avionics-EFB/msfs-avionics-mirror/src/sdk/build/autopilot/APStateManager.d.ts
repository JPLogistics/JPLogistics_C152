...
export declare abstract class APStateManager {
    ...
    lateralPressed: SubEvent<APModePressEvent>;
    verticalPressed: SubEvent<APModePressEvent>;
    approachPressed: SubEvent<boolean | undefined>;
    vnavPressed: SubEvent<boolean>;
