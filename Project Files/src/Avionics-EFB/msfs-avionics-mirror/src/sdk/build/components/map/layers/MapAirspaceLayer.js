import { BitFlags, ClippedPathStream, FSComponent, GeoPoint, UnitType, VecNSubject } from '../../..';
import { FacilityLoader, FacilityRespository, FacilitySearchType, NearestLodBoundarySearchSession } from '../../../navigation';
...
export class MapAirspaceLayer extends MapLayer {
    constructor() {
        ...
        this.facLoader = new FacilityLoader(FacilityRespository.getRepository(this.props.bus), async () => {
