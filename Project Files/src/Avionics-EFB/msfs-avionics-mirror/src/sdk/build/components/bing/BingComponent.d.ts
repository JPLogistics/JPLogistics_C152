...
import { ComponentProps, DisplayComponent, Subscribable, SubscribableArray, VNode } from '../..';
/**
...
export declare class BingComponent extends DisplayComponent<BingComponentProps> {
    ...
    private readonly earthColorsSub;
    private readonly skyColorSub;
    private readonly referenceSub;
    private readonly wxrModeSub;
