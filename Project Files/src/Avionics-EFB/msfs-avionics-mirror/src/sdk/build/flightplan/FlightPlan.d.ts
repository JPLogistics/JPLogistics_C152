import { FlightPlanLeg, OneWayRunway } from '../navigation';
...
export declare class FlightPlan {
    ...
    onLegNameRequested: (leg: FlightPlanLeg) => string;
     ...
     */
    constructor(planIndex: number, calculator: FlightPathCalculator);
    /**
     ...
     */
    addLeg(segmentIndex: number, leg: FlightPlanLeg, index?: number, flags?: number, notify?: boolean): LegDefinition;
    /**
     ...
     * @throws An error if the leg could not be found.
     */
    getLeg(index: number): LegDefinition;
    /**
     ...
     * @returns A flight plan leg, or `null` if one could not be found at the specified index.
     */
    tryGetLeg(index: number): LegDefinition | null;
    /**
     * Attempts to get a leg from the flight plan.
     ...
     */
    removeLeg(segmentIndex: number, index?: number, notify?: boolean): LegDefinition | null;
    /**
     * Calculates the flight path for the plan.
     * @param index The leg index to start calculating from.
     * @param notify Whether or not to send notifications after the operation.
     */
    calculate(index?: number, notify?: boolean): Promise<void>;
    /**
     ...
     * @param notify Whether or not to send notifications after the operation.
     */
    setLateralLeg(index: number, notify?: boolean): void;
    /**
     * Sets the active lateral leg index in the flight plan.
     * @param index The index to set.
     * @param notify Whether or not to send notifications after the operation.
     */
    setVerticalLeg(index: number, notify?: boolean): void;
    /**
     * Sets the active calculating leg index in the flight plan.
     * @param index The index to set.
     * @param notify Whether or not to send notifications after the operation.
     */
    setCalculatingLeg(index: number, notify?: boolean): void;
    /**
     ...
     */
    getSegmentIndex(legIndex: number): number;
    /**
     ...
     */
    buildDefaultLegName(leg: FlightPlanLeg): string;
    /**
