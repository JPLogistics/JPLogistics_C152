import { GeoCircle, LatLonInterface } from '..';
...
export declare class CircleVectorBuilder {
     ...
     */
    build(vectors: FlightPathVector[], index: number, direction: VectorTurnDirection, radius: number, center: Float64Array | LatLonInterface, start: Float64Array | LatLonInterface, end: Float64Array | LatLonInterface, flags?: number): 1;
    /**
     * Builds a circle vector and adds it to a sequence.
     * @param vectors The flight path vector sequence to which to add the vector.
     * @param index The index in the sequence at which to add the vector.
     ...
     * @returns The number of vectors added to the sequence, which is always equal to 1.
     */
    build(vectors: FlightPathVector[], index: number, circle: GeoCircle, start: Float64Array | LatLonInterface, end: Float64Array | LatLonInterface, flags?: number): 1;
    /**
...
export declare class GreatCircleBuilder {
     ...
     */
    build(vectors: FlightPathVector[], index: number, start: Float64Array | LatLonInterface, end: Float64Array | LatLonInterface, initialCourse?: number, flags?: number): number;
    /**
     ...
     * @param flags The flags to set on the vector. Defaults to none (0).
     */
    build(vectors: FlightPathVector[], index: number, start: Float64Array | LatLonInterface, path: GeoCircle, end: Float64Array | LatLonInterface, flags?: number): number;
    /**
     ...
     * @param flags The flags to set on the vector. Defaults to none (0).
     */
    build(vectors: FlightPathVector[], index: number, start: Float64Array | LatLonInterface, path: GeoCircle, distance: number, flags?: number): number;
    /**
...
export declare class TurnToCourseBuilder {
     ...
     * @returns The number of vectors added to the sequence.
     */
    build(vectors: FlightPathVector[], index: number, start: Float64Array | LatLonInterface, radius: number, direction: VectorTurnDirection, fromCourse: number, toCourse: number, flags?: FlightPathVectorFlags): 1;
}
/**
...
export declare class CircleInterceptBuilder {
     ...
     * @returns The number of vectors added to the sequence.
     */
    build(vectors: FlightPathVector[], index: number, start: Float64Array | LatLonInterface, course: number, circle: GeoCircle, flags?: number): number;
    /**
     ...
     */
    build(vectors: FlightPathVector[], index: number, start: Float64Array | LatLonInterface, startPath: GeoCircle, circle: GeoCircle, flags?: number): number;
}
/**
...
export declare class TurnToJoinGreatCircleBuilder {
     ...
     */
    build(vectors: FlightPathVector[], index: number, start: Float64Array | LatLonInterface, startCourse: number, endPath: GeoCircle, radius: number, flags?: number): 1;
    /**
     * Builds an arc representing a turn from a defined start point and initial course toward a defined target great-
     * circle path, ending at the point in the turn circle which is closest to the target path.
     * @param vectors The flight path vector sequence to which to add the vectors.
     ...
     */
    build(vectors: FlightPathVector[], index: number, start: Float64Array | LatLonInterface, startPath: GeoCircle, endPath: GeoCircle, radius: number, flags?: number): 1;
}
/**
...
export declare class ConnectCirclesBuilder {
     ...
     * @returns The number of vectors added to the sequence.
     */
    build(vectors: FlightPathVector[], index: number, fromCircle: GeoCircle, toCircle: GeoCircle, radius?: number, from?: Float64Array | LatLonInterface, to?: Float64Array | LatLonInterface, fromCircleVectorFlags?: number, toCircleVectorFlags?: number, connectVectorFlags?: number): number;
    /**
...
export declare class TurnToJoinGreatCircleAtPointBuilder {
     ...
     * @returns The number of vectors added to the sequence.
     */
    build(vectors: FlightPathVector[], index: number, start: Float64Array | LatLonInterface, startPath: GeoCircle, startTurnRadius: number, startTurnDirection: VectorTurnDirection, end: Float64Array | LatLonInterface, endPath: GeoCircle, endTurnRadius: number, endTurnDirection: VectorTurnDirection, startTurnVectorFlags?: number, endTurnVectorFlags?: number, connectVectorFlags?: number): number;
}
/**
...
export declare class JoinGreatCircleToPointBuilder {
     ...
     * @returns The number of vectors added to the sequence.
     */
    build(vectors: FlightPathVector[], index: number, start: Float64Array | LatLonInterface, startPath: GeoCircle, end: Float64Array | LatLonInterface, endPath: GeoCircle, desiredTurnDirection?: VectorTurnDirection, minTurnRadius?: number, preferSingleTurn?: boolean, intersection?: Float64Array, flags?: number, includeTurnToCourseFlag?: boolean): number;
}
/**
