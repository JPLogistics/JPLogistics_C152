...
import { AltitudeRestrictionType, ICAO, LegType } from '../navigation';
...
export class FlightPlan {
    ...
    *segmentsOfType(segmentType) {
     ...
     */
    addLeg(segmentIndex, leg, index, flags = 0, notify = true) {
        const segment = this.getSegment(segmentIndex);
        const legDefinition = { leg, flags, verticalData: { altDesc: AltitudeRestrictionType.Unused, altitude1: 0, altitude2: 0 } };
        if (index === undefined) {
