import { GeoCircle, GeoPoint, LatLonInterface } from '..';
...
export declare class FlightPathUtils {
     ...
     */
    static setCircleVector(vector: CircleVector, circle: GeoCircle, start: Float64Array | LatLonInterface, end: Float64Array | LatLonInterface, flags: number): CircleVector;
    /**
     ...
     */
    static getTurnCircle(center: Float64Array | LatLonInterface, radius: number, turnDirection: VectorTurnDirection, out: GeoCircle): GeoCircle;
    /**
     ...
     */
    static getAlongArcSignedDistance(circle: GeoCircle, start: Float64Array | LatLonInterface, end: Float64Array | LatLonInterface, pos: Float64Array | LatLonInterface, tolerance?: number): number;
    /**
     ...
     */
    static getAlongArcNormalizedDistance(circle: GeoCircle, start: Float64Array | LatLonInterface, end: Float64Array | LatLonInterface, pos: Float64Array | LatLonInterface, tolerance?: number): number;
    /**
