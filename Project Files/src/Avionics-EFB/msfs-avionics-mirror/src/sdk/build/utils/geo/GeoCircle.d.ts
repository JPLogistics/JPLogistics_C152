...
export declare class GeoCircle {
     ...
     */
    set(center: Float64Array | LatLonInterface, radius: number): this;
    /**
     ...
     * @returns this circle, after it has been changed.
     */
    setAsGreatCircle(point1: Float64Array | LatLonInterface, point2: Float64Array | LatLonInterface): this;
    /**
     ...
     * @returns this circle, after it has been changed.
     */
    setAsGreatCircle(point: Float64Array | LatLonInterface, bearing: number): this;
    /**
     ...
     */
    closest(point: Float64Array | LatLonInterface, out: Float64Array): Float64Array;
    /**
     * Finds the closest point on this circle to a specified point. In other words, projects the specified point onto
     * this circle. If the specified point is equidistant from all points on this circle (i.e. it is coincident with or
     * antipodal to this circle's center), NaN will be written to all fields of the result.
     ...
     * @returns The closest point on this circle to the specified point.
     */
    closest(point: Float64Array | LatLonInterface, out: GeoPoint): GeoPoint;
    /**
     ...
     */
    distance(point: Float64Array | LatLonInterface): number;
    /**
     ...
     */
    includes(point: Float64Array | LatLonInterface, tolerance?: number): boolean;
    /**
     ...
     */
    encircles(point: Float64Array | LatLonInterface, inclusive?: boolean, tolerance?: number): boolean;
    /**
     ...
     */
    angleAlong(start: Float64Array | LatLonInterface, end: Float64Array | LatLonInterface, tolerance?: number): number;
    /**
     ...
     * @throws Error if either point does not lie on this circle.
     */
    distanceAlong(start: Float64Array | LatLonInterface, end: Float64Array | LatLonInterface, tolerance?: number): number;
    /**
     ...
     */
    bearingAt(point: Float64Array | LatLonInterface, tolerance?: number): number;
    /**
     ...
     * @throws Error if the point does not lie on this circle.
     */
    offsetDistanceAlong(point: Float64Array | LatLonInterface, distance: number, out: Float64Array, tolerance?: number): Float64Array;
    /**
     * Offsets a point on this circle by a specified distance. The direction of the offset for positive distances is
     * counterclockwise when viewed from above the center of this circle.
     * @param point The point to offset.
     ...
     * @throws Error if the point does not lie on this circle.
     */
    offsetDistanceAlong(point: Float64Array | LatLonInterface, distance: number, out: GeoPoint, tolerance?: number): GeoPoint;
    /**
     ...
     * @throws Error if the point does not lie on this circle.
     */
    offsetAngleAlong(point: Float64Array | LatLonInterface, angle: number, out: Float64Array, tolerance?: number): Float64Array;
    /**
     * Offsets a point on this circle by a specified angular distance. The direction of the offset for positive distances
     * is counterclockwise when viewed from above the center of this circle.
     * @param point The point to offset.
     ...
     * @throws Error if the point does not lie on this circle.
     */
    offsetAngleAlong(point: Float64Array | LatLonInterface, angle: number, out: GeoPoint, tolerance?: number): GeoPoint;
    /**
     * Offsets a point on this circle by a specified angular distance. The direction of the offset for positive distances
     * is counterclockwise when viewed from above the center of this circle.
     * @param point The point to offset.
     ...
     */
    static createGreatCircle(point1: Float64Array | LatLonInterface, point2: Float64Array | LatLonInterface): GeoCircle;
    static createGreatCircle(point: Float64Array | LatLonInterface, bearing: number): GeoCircle;
    /**
     ...
     * @returns a great circle.
     */
    static createGreatCircleFromPointBearing(point: Float64Array | LatLonInterface, bearing: number): GeoCircle;
    /**
     ...
     */
    static getGreatCircleNormal(point1: Float64Array | LatLonInterface, point2: Float64Array | LatLonInterface, out: Float64Array): Float64Array;
    /**
     ...
     * @returns the normal vector for the great circle.
     */
    static getGreatCircleNormal(point: Float64Array | LatLonInterface, bearing: number, out: Float64Array): Float64Array;
    /**
