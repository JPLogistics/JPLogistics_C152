...
export class MapComponent extends DisplayComponent {
    ...
    constructor(props) {
        ...
        this.mapProjection = (_a = this.props.projection) !== null && _a !== void 0 ? _a : new MapProjection(this.props.projectedWidth, this.props.projectedHeight);
    }
    /**
...
class LayerEntry {
    ...
    attach() {
        ...
        this.updateFreqSub = (_b = this.layer.props.updateFreq) === null || _b === void 0 ? void 0 : _b.sub(this.freqHandler, true);
