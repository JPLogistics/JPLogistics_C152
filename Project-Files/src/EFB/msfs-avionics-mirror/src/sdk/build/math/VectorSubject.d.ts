 ...
 */
export declare class Vec2Subject extends Subject<ReadonlyFloat64Array> {
    /**
     * Sets the new value and notifies the subscribers if the value changed.
     * @param value The new value.
     */
    set(value: ReadonlyFloat64Array): void;
    /**
     * Sets the new value and notifies the subscribers if the value changed.
 ...
 */
export declare class Vec3Subject extends Subject<ReadonlyFloat64Array> {
    /**
     * Sets the new value and notifies the subscribers if the value changed.
     * @param value The new value.
     */
 ...
 */
export declare class VecNSubject extends Subject<ReadonlyFloat64Array> {
    /**
     * Sets the new value and notifies the subscribers if the value changed.
     * @param value The new value.
     */
