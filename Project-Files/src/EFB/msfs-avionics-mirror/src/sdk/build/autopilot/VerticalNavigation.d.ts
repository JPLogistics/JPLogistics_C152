 ...
 */
export declare enum VNavPathMode {
 ...
 */
export declare enum ApproachGuidanceMode {
 ...
 */
export declare enum VNavAltCaptureType {
 ...
 */
export declare enum VerticalFlightPhase {
 ...
 */
export declare enum VNavAvailability {
    Available = "Available",
    InvalidLegs = "InvalidLegs"
}
//# sourceMappingURL=VerticalNavigation.d.ts.map