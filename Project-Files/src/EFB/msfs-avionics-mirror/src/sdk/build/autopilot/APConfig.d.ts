...
export declare enum APVerticalModes {
    NONE = 0,
    PITCH = 1,
    VS = 2,
    FLC = 3,
...
export declare enum APLateralModes {
    NONE = 0,
    ROLL = 1,
    LEVEL = 2,
    GPSS = 3,
...
export declare enum APAltitudeModes {
    NONE = 0,
    ALTS = 1,
    ALTV = 2
}
/** AP Values Object */
export declare type APValues = {
...
//# sourceMappingURL=APConfig.d.ts.map