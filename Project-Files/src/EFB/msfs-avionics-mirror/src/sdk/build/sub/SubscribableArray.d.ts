 ...
 */
export declare type SubscribableArrayHandler<T> = (index: number, type: SubscribableArrayEventType, item: T | readonly T[] | undefined, array: readonly T[]) => void;
/**
...
//# sourceMappingURL=SubscribableArray.d.ts.map