 ...
 */
export declare enum SubscribableSetEventType {
    /** A key was added. */
    Added = "Added",
    /** A key was deleted. */
    Deleted = "Deleted"
 ...
 */
export declare type SubscribableSetHandler<T> = (set: ReadonlySet<T>, type: SubscribableSetEventType, key: T) => void;
/**
...
//# sourceMappingURL=SubscribableSet.d.ts.map