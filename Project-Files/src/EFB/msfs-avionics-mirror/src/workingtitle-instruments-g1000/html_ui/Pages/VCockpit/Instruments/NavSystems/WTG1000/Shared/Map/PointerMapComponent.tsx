import { FSComponent, GeoPointInterface, NumberUnitInterface, ReadonlyFloat64Array, Subject, Subscribable, UnitFamily, Vec2Math, VecNSubject } from 'msfssdk';
...
export abstract class PointerMapRangeTargetRotationController<M extends PointerMapModules = PointerMapModules> extends BaseMapRangeTargetRotationController<M> {
  ...
  constructor(
    ...
    protected readonly pointerBounds: Subscribable<ReadonlyFloat64Array>
  ) {
